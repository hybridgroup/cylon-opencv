...
var OpenCV = module.exports = function OpenCV(opts) {
  if (opts == null) {
    opts = {};
  }
...
Cylon.Utils.subclass(OpenCV, Cylon.Adaptor);

OpenCV.prototype.commands = [
  'readFrame', 'initCamera',
  'detectFaces', 'createWindow',
  'showFrame', 'readImage'
];

OpenCV.prototype.connect = function() {
  return OpenCV.__super__.connect.apply(this, arguments);
};

OpenCV.prototype.disconnect = function() {
  return Cylon.Logger.debug("Disconnecting from opencv '" + this.name + "'...");
};
